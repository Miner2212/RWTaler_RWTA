...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RWTalerTestFramework
    pass

class ExampleTest(RWTalerTestFramework):
    # Each functional test is a subclass of the RWTalerTestFramework class.
    ...
    def custom_method(self):
        ...
        RWTalerTestFramework class so other tests can use it."""
