...
ACLOCAL = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
BOOST_LIBS = -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_chrono -lboost_random -lboost_chrono
...
COPYRIGHT_HOLDERS_FINAL = The RWTalercore developers
COPYRIGHT_HOLDERS_SUBSTITUTION = RWTalercore
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
CXXFLAGS = -Wno-unknown-pragmas -Wno-deprecated-declarations -Wno-cpp -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OBJCXXFLAGS = -Wno-unknown-pragmas -Wno-deprecated-declarations -Wno-cpp -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
PACKAGE = rwtaler
PACKAGE_BUGREPORT = https://github.com/rwtaler-core/rwtaler/issues
PACKAGE_NAME = RWTalercore
PACKAGE_STRING = RWTalercore 1.2.0
PACKAGE_TARNAME = rwtaler
PACKAGE_URL = https://spidervps.net/
...
SET_MAKE = 
SHELL = /bin/bash
SSE42_CXXFLAGS = -msse -msse2 -msse4.1 -msse4.2
SSL_CFLAGS = 
SSL_LIBS = -lssl
STRIP = /usr/bin/strip
TESTDEFS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/miner/RWTaler_RWTA
abs_srcdir = /home/miner/RWTaler_RWTA
abs_top_builddir = /home/miner/RWTaler_RWTA
abs_top_srcdir = /home/miner/RWTaler_RWTA
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/miner/RWTaler_RWTA/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/rwtalerd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/rwtaler-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/rwtaler-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_rwtaler_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_rwtaler_coverage.info test_rwtaler.info
...
#test_rwtaler.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_rwtaler -o $@
...
#block_test.info: test_rwtaler_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_rwtaler_coverage.info: baseline_filtered_combined.info test_rwtaler_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_rwtaler_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_rwtaler_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_rwtaler_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt
...
clean-local:
	rm -rf test_rwtaler.coverage/ total.coverage/ $(OSX_APP)
