...
confused with overall RWTA Network Protocol consensus changes.
...
Patches that change RWTA consensus rules are considerably more involved than
...
Where a patch set proposes to change the RWTA consensus, it must have been
