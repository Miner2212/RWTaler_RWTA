...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total rwtaler balance of the wallet\n"
            "  \"darksend_balance\": xxxxxx, (numeric) the anonymized rwtaler balance of the wallet\n"
...
UniValue getstateinfo(const UniValue& params, bool fHelp)
{
    ...
    RWTalerDGP rwtalerDGP(globalState.get());

    UniValue obj(UniValue::VOBJ);
    obj.push_back(Pair("maxblocksize", (int)rwtalerDGP.getBlockSize(chainActive.Height())));
    obj.push_back(Pair("blockgaslimit", (int)rwtalerDGP.getMinGasPrice(chainActive.Height())));
    obj.push_back(Pair("mingasprice", (int)rwtalerDGP.getBlockGasLimit(chainActive.Height())));
