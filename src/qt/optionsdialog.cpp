...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    // if set in rwtaler.conf or in startup command line, sync and gray the checkboxes
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeRWTaler, OptionsModel::AnonymizeRWTalerAmount);
