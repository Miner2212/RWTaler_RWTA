...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The RWTalercore developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "RWTalercore"
...
#define PACKAGE_BUGREPORT "https://github.com/rwtaler-core/rwtaler/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RWTalercore"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RWTalercore 1.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rwtaler"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://spidervps.net/"
