...
////////////////////////////////////////////////////////////// // rwtaler
	void setRWTalerSchedule(EVMSchedule _rwtalerSchedule) const { rwtalerSchedule = _rwtalerSchedule; }

	EVMSchedule& getRWTalerSchedule() const { return rwtalerSchedule; }
...
private:
	...
	mutable EVMSchedule rwtalerSchedule; // rwtaler
